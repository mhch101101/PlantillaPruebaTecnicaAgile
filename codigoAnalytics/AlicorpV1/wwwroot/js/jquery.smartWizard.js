...
;(function ($, window, document, undefined) {
    "use strict";
    // Default options
    var paso; //Capturando el numero de paso del tab para poder validar por tabs
    ...
    var defaults = {
        ...
        anchorSettings: {
            anchorClickable: false, // Enable/Disable anchor navigation//Aqui se Habilita/Deshabilita
            enableAllAnchors: false, // Activates all anchors clickable all times// Aqui tambien se deshabilita
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button id="btnSiguiente" style="display:none;"></button>').text(this.options.lang.next).addClass('btn btn-info sw-btn-next').attr('type', 'button') : null;
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button id="btnAnterior" style="display:none;"></button>').text(this.options.lang.previous).addClass('btn btn-danger sw-btn-prev').attr('type', 'button') : null;
        ...
        _transitPage: function (idx) {
            ...
            paso = this.current_index
            this._triggerEvent("showStep", [selTab,paso, stepDirection, stepPosition]);
            return true;
        },
